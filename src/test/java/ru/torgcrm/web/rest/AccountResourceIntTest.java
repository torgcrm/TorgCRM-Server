package ru.torgcrm.web.rest;

import ru.torgcrm.config.Constants;
import ru.torgcrm.TorgCrmceApp;
import ru.torgcrm.domain.Authority;
import ru.torgcrm.domain.User;
import ru.torgcrm.repository.AuthorityRepository;
...
import ru.torgcrm.service.dto.UserDTO;
import ru.torgcrm.web.rest.errors.ExceptionTranslator;
import ru.torgcrm.web.rest.vm.KeyAndPasswordVM;
import ru.torgcrm.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = TorgCrmceApp.class)
