...
describe('Service Tests', () => {
    ...
    describe('CustomerType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CustomerTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/customer-types/' + 123);
            });
            it('should return CustomerType', () => {

                let entity: CustomerType;
                service.find(123).subscribe((_entity: CustomerType) => {
                    entity = _entity;
                });
